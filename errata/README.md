...
## 페이지 : 336 ~ 337
### 내용 개선 : 336페이지의 내용 설명과 표 6-5의 화살표가 일치하지 않음
<pre>
p336, pop(0)을 하기 전과 후에 lst[1]은 22에서 33으로 바뀌고, dic[1]은 변동 없이 22임을 설명함.
</pre>
내용과 표의 일관성 맞춤
<pre>
p336, pop(0)을 하기 전과 후에 lst[2]은 33에서 44으로 바뀌고, dic[2]은 변동 없이 33임을 설명하거나
p337, 표 6-5의 화살표를 [1]의 위치로 변경

그 뒤의 실습코드가 전부 [1]을 기준으로 설명하고 있어서, [표 6-5]의 화살표를 변경하는 것이 더 간단해 보입니다.
</pre>
